...
namespace PTemplate.Areas.Admin.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Idprovince,Idcounty,Name")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Idprovince,Idcounty,Name")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
